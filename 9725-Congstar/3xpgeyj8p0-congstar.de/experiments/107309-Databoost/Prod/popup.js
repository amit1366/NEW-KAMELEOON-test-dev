  ...
  <div class="kam-popup__container">
    ...
    <div class="kam-popup__main-items">
      ...
      <div class="kam-purchase-offer">
        <div class="kam-price">
          <span class="kam-price__eurs">${price.value}</span>
          <span class="kam-price__cents">${price.cents}</span>
