...
export const logic = (campaignParameter, addtionalFootnoteText, promotionListText) => {
        ...
        for (const mutation of mutationList) {
            if (
                mutation.addedNodes.length === 1
                    ...
                    && mutation.addedNodes[0].classList.contains('ReactModal__Overlay')
                    && mutation.addedNodes[0].querySelector('[data-testid*="comp-footnote-modal-footnoteItemId-"]')
                    && mutation.addedNodes[0].querySelector('header h4').innerText.includes('Allnet Flat')
            ) {
