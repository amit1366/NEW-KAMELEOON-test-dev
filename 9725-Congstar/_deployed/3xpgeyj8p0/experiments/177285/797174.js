...
if (!document.location.pathname.includes('/checkout/bestaetigung')) {
  const bannerData = {
    ...
    text: 'Du hast Freunde, die bereits bei congstar Kunde sind? Lass dich werben und sichere deinen Freunden und dir mit congstar for friends exklusive Vorteile.',
    button: 'Wie geht das?',
    link: 'https://www.congstar.de/for-friends',
    images: [images.generic, images.genericMobile]
  };
