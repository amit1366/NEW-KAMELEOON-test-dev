...
const variationScript = selector => {
  Kameleoon.API.Core.runWhenElementPresent(selector, ([sibling]) => {
    sibling.insertAdjacentHTML('beforebegin', banner);
  }, 100);
};

variationScript('checkout-cart common-page-layout > div:nth-child(1)');